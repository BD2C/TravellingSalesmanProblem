...
class Taboo(object):
	def __init__(self, parcour, graphe):
		...
		self.n = len(parcour)
		#self.best_solution = copy.copy(self.parcour)
...
#######################################################  on importe la classe dyal recuit simule : from taboooooo import Taboo
#######################################################  on aplle l'algo avec : tb = Taboo(a,e)
#######################################################                      tb.tboo()
####################################################### ou "a" est le parcours [1,2,5,4,3,6] et "e" la matrice de distances			