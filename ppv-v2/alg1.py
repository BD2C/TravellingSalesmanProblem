...
class SimRecuit(object):
    ...
    def f(self, sol):
        ''' valeur objectif de la solution f(x) ou x est la solution page 5 smaha ampleur de la deterioration li hya la fonction li katrj3lna cout dyal parcours''' 
    ...
    def Recuit(self):
        ...
        while self.T >= self.stop_temp:
            ...
            i = random.randint(0, self.N-l)#######################"hadi hya kifach kankhalto l parcours"#####
...
#######################################################  on importe la classe dyal recuit simule : from alg1 import SimRecuit
#######################################################  on aplle l'algo avec : sa = SimRecuit(a,e)
#######################################################                      sa.Recuit()
####################################################### ou a est le parcours [1,2,5,4,3,6] et a la matrice de distance